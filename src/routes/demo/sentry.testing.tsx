    ...
    return (
      <main className="demo-page demo-center">
        <section className="demo-panel text-center">
          <SentryLogo />
          <h1 className="mt-4 mb-2 font-bold text-2xl">Something went wrong</h1>
...
function FeatureCard({
  ...
  return (
    <div className="demo-card group transition-all">
  ...
  return (
    <div className="mt-4 space-y-3">
      ...
      <button
        type="button"
        onClick={handleCopy}
        className="demo-list-item relative flex w-full cursor-pointer items-center gap-2 transition-all"
      >
        <span className="demo-muted text-sm">span.op:</span>
        <code className="font-mono text-sm">{spanOp}</code>
        <svg
          className="demo-muted ml-auto h-4 w-4"
          fill="none"
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeWidth="2"
...
function ProgressBar({ loading }: { loading: boolean }) {
  return (
    <div className="mt-4 flex items-center gap-3">
      ...
      <span className="demo-muted w-16 text-right text-xs">
      ...
      <div className="mx-auto max-w-5xl">
        ...
        {showWarning && (
          <div className="demo-alert mb-8 flex items-center gap-3">
            <svg
              className="h-6 w-6 flex-shrink-0 text-[var(--sea-ink-soft)]"
              fill="none"
              strokeLinecap="round"
              strokeLinejoin="round"
              strokeWidth="2"
